...
void BeschleunigungsAuswertung_initialize(void)
{
  ...
  /* External mode info */
  BeschleunigungsAuswertung_M->Sizes.checksums[0] = (2519752968U);
  BeschleunigungsAuswertung_M->Sizes.checksums[1] = (2741625883U);
  BeschleunigungsAuswertung_M->Sizes.checksums[2] = (895642084U);
  BeschleunigungsAuswertung_M->Sizes.checksums[3] = (204005976U);
