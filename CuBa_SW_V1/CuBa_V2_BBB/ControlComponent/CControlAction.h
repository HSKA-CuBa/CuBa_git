...
private:
	...
	TKalmanFilter<ControlConfig::KalmanVarianceSize> mKalmanPhi;
	TKalmanFilter<ControlConfig::KalmanVarianceSize> mKalmanPhi__d;
	CComplementaryFilter mCompFilter;
	TFloatingMean<4> mMean4;
	TFloatingMean<8> mMean8;
	TFloatingMean<16> mMean16;
	CLQR mLQR;
	Float32 mTime;
	EFilter mFilterPhi;
	EFilter mFilterPhi__d;
	EFilter mFilterPsi__d;
};
