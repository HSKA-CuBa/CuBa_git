...
CCountingSemaphore::CCountingSemaphore(bool isProcessShared, Int32 startingValue) : mCounter(startingValue)
{
	...
	sAssertion(0 == retVal, "(CCoutingSemaphore::CCountingSemaphore()) : Failed to init Mutex-Attribute!");

	retVal = pthread_mutexattr_settype(&mutexAttr, PTHREAD_MUTEX_ERRORCHECK);
	sAssertion(0 == retVal, "(CCountingSemaphore::CCountingSemaphore()) : Failed to set Mutex-Type!");

	retVal = pthread_mutex_init(&mMutex, &mutexAttr);
	sAssertion(0 == retVal , "(CCountingSemaphore::CCountingSemaphore()) : Failed to init Mutex!");

	retVal = pthread_mutexattr_destroy(&mutexAttr);
	sAssertion(0 == retVal, "(CCountingSemaphore::CCountingSemaphore()) : Failed to destroy Mutex-Attribute!");

	pthread_condattr_t conditionAttr;
	retVal = pthread_condattr_init(&conditionAttr);
	sAssertion(0 == retVal, "(CCountingSemaphore::CCoutingSemaphore()) : Failed to init Condition-Attribute!");

	retVal = pthread_condattr_setpshared(&conditionAttr, isProcessShared ?
										 PTHREAD_PROCESS_SHARED : PTHREAD_PROCESS_PRIVATE);
	sAssertion(0 == retVal, "(CCoutingSmeaphore::CCoutingSemaphore()) : Failed to set Condition-Attribute!");
...
CCountingSemaphore::~CCountingSemaphore()
{
	...
	sAssertion(0 == retVal, "(CCountingSemaphore::~CCountingSemaphore()) : Failed to destroy condition variable!");
}
