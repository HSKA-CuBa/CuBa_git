...
%Values have to be adjusted because of ordinary pendulum setup
...
plot(t, radtodeg(phi_raw),...
     compFilter.mTime, compFilter.mFilteredPhi,...
...
print('plots/fitervergleich_phi.eps', '-depsc');
...
ylabel('$\dot{\varphi} \big[\frac{^\circ}{s} \big]$', 'interpreter', 'latex', 'fontsize', 13);
title('Vergleich der Filter von $\boldmath \dot{\varphi}$', 'interpreter', 'latex', 'fontsize', 14);
print('plots/filtervergleich_phi__d.eps', '-depsc');

figure;
plot(t, radtodeg(kalmanFilter.mPhi)); grid;
xlabel('$\boldmath t \big[s \big]$', 'interpreter', 'latex', 'fontsize', 13);
ylabel('$\boldmath \varphi \big[\ \big]$', 'interpreter', 'latex', 'fontsize', 13);
title('Bestimmung von $C_{\varphi}$', 'interpreter', 'latex', 'fontsize', 14);
print('plots/C_phi.eps', '-depsc');
