 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Jul 30 09:45:52 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Sensoren_CustomBlock
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      ZAngularVelocity
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    int16_T        *ZAngularVelocity  = (int16_T *)ssGetOutputPortRealSignal(S,1);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const uint32_T  *LPBW  = (const uint32_T *)mxGetData(PARAM_DEF0(S));

    Sensoren_CustomBlock_Outputs_wrapper(XAcceleration, ZAngularVelocity, xD, LPBW, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    Sensoren_CustomBlock_Update_wrapper(XAcceleration, ZAngularVelocity,  xD, LPBW, p_width0);
}
