 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Thu Jul 28 13:49:33 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME LED_CustomBlock
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          1
/* Input Port  0 */
#define IN_PORT_0_NAME      ledState
...
{
    const boolean_T   *ledState  = (const boolean_T*) ssGetInputPortSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);

    LED_CustomBlock_Outputs_wrapper(ledState, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    LED_CustomBlock_Update_wrapper(ledState,  xD);
}
