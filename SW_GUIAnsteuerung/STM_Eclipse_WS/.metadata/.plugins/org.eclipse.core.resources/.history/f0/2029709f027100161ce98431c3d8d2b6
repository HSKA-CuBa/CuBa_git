...
void TUSART<ERegister::rUSART1>::init()
{
    ...
    *sUSART_BRR  |= 0x2224U;		//DANGER vorher 0x2224U
...
void TUSART<ERegister::rUSART3>::init()
{
	...
	*sUSART_BRR  |= 0x1114U;				//9600 baud
	*sUSART_CR1  |= 0b0010000000001100U; 	//UE (usart enable), TE (transmit enable), RE (receive enable), (default: 8 Databits, no Parity)
	*sUSART_CR2  |= 0b000000000000000U;		//default: 1 Stopbit
	*sUSART_CR3  |= 0b000000000000U;		//default: nCTS disable, nRTS disable (no Handshake)
}
template<>
