...
grid; xlabel('$\varphi [^\circ]$', 'interpreter', 'latex');
ylabel('$\ddot{x} [\frac{m}{s^2}]$', 'interpreter', 'latex');
...
legend('Ausgleichspolynom', 'Sollwert', 'Abweichung', 'Location', 'west');
clear title;    %Workaround mathworks
title('Ausgleichspolynom X-Beschleunigung Sensor 2');
print('plots/X2__dd___fitted', '-depsc');
figure;
plot(phiArr, y1_corrected__dd, phiArr, y_targetArr__dd, phiArr, y1_error);
grid; xlabel('$\varphi [^\circ]$', 'interpreter', 'latex');
ylabel('$\ddot{y} [\frac{m}{s^2}]$', 'interpreter', 'latex');
legend('Ausgleichspolynom', 'Sollwert', 'Abweichung', 'Location', 'west');
clear title;    %Workaround mathworks
title('Ausgleichspolynom Y-Beschleunigung Sensor 1');
...
legend('Ausgleichspolynom', 'Sollwert', 'Abweichung', 'Location', 'west');
clear title;    %Workaround mathworks
title('Ausgleichspolynom Y-Beschleunigung Sensor 2');
