...
{
	float phi1__d = Config::Phi1__d_P1 * (static_cast<float>(phi1__d_raw + Config::Phi1__d_P2)) * 0.0175F;
	float phi2__d = Config::Phi2__d_P1 * (static_cast<float>(phi2__d_raw + Config::Phi2__d_P2)) * 0.0175F;
