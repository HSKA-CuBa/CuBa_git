...
void V3_AusgleichsPolynomPsi__d_initialize(void)
{
  ...
  /* External mode info */
  V3_AusgleichsPolynomPsi__d_M->Sizes.checksums[0] = (4000070599U);
  V3_AusgleichsPolynomPsi__d_M->Sizes.checksums[1] = (774069118U);
  V3_AusgleichsPolynomPsi__d_M->Sizes.checksums[2] = (428855088U);
  V3_AusgleichsPolynomPsi__d_M->Sizes.checksums[3] = (331702268U);
