...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/V6___LQR_Regelung.elf
...
PRODUCT_NAME              = V6___LQR_Regelung
MAKEFILE                  = V6___LQR_Regelung.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/ich/Desktop/CuBa_git/Versuche_Messungen/V6___LQR_Regelung
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = V6___LQR_Regelung_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/V6___LQR_Regelung.elf
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/V6___LQR_Regelung_ert_rtw -I$(START_DIR) -I$(START_DIR)/MotorBlock/include -I$(START_DIR)/MPU6050/include -I$(START_DIR)/MotorBlock/source -I$(START_DIR)/MPU6050/source -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/serial -IC:/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/armcortexmbase/scheduler/include -IC:/MATLAB/SupportPackages/R2016a/STM32F4-Discovery_FW_V1.1.0/Libraries/CMSIS/ST/STM32F4xx/Include -IC:/MATLAB/SupportPackages/R2016a/CMSIS/CMSIS/Include -IC:/MATLAB/SupportPackages/R2016a/STM32F4-Discovery_FW_V1.1.0/Project/Peripheral_Examples/SysTick -IC:/MATLAB/SupportPackages/R2016a/STM32F4-Discovery_FW_V1.1.0/Libraries/STM32F4xx_StdPeriph_Driver/inc -IC:/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/stm32f4discovery/@slCustomizer/../include -IC:/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/armcortexmbase/cmsis_rtos_rtx/include
...
DEFINES_ = -DMODEL=V6___LQR_Regelung -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DUSE_STDPERIPH_DRIVER -DUSE_STM32F4_DISCOVERY -DSTM32F4XX -DARM_MATH_CM4=1 -D__FPU_PRESENT=1 -D__FPU_USED=1 -DHSE_VALUE=8000000 -DNULL=0 -D__START=_start -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=V6___LQR_Regelung -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = V6___LQR_Regelung.o V6___LQR_Regelung_data.o ADC.o MotorControl.o stm32f4xx_adc.o stm32f4xx_tim.o stm32f4xx_i2c.o MPU6050.o ext_svr.o updown.o ext_work.o rtiostream_utils.o MPU6050_CustomBlock_wrapper.o SensorenFilter_Block_wrapper.o MotorADC_wrapper.o Motor_wrapper.o blapp_support.o startup_stm32f4xx.o syscalls_stm32f4xx.o stm32f4xx_init_board.o system_stm32f4xx.o SysTickScheduler.o m3m4m4f_multitasking.o ext_serial_pkt.o rtiostream_serial_interface.o ext_svr_serial_transport.o rtiostream_serial_dma_stm32f4xx.o stm32f4xx_usart.o stm32f4xx_rcc.o stm32f4xx_gpio.o stm32f4xx_dma.o misc.o
...
%.o : $(START_DIR)/V6___LQR_Regelung_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/V6___LQR_Regelung_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/V6___LQR_Regelung_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/V6___LQR_Regelung_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/V6___LQR_Regelung_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
