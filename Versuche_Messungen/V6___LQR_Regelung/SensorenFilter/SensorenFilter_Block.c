...
/* Output Port  0 */
#define OUT_PORT_0_NAME      phi__raw
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      phi__comp
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      phi__kalman
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real32_T        *phi__d  = (real32_T *)ssGetOutputPortRealSignal(S,3);
